"""Literal templates extracted from a real EasyEDA Pro document (see the documentation).

Source: ~/Documents/EasyEDA-Pro/projects/eblocks.eprj2 (the user's own project, read-only —
never modified by this framework). The lists below are the boilerplate lines from a real PCB
document (docType 3, doc "pcb9" of the project) and a real footprint document (docType 4,
footprint "r0603"), copied literally — not a third-party reconstruction.

`PCB_*`: layer/rule/preference header of a complete PCB document, identical across PCB
documents of the same project (does not depend on the circuit content — hence safe to reuse as
fixed boilerplate).

`FOOTPRINT_LAYERS`: layer header of a footprint document (subset of the PCB layers relevant to
an isolated footprint).

Not copied (out of scope for the MVP, see the documentation): `PANELIZE_STAMP`/`PANELIZE_SIDE` lines
(manufacturing panels with multiple boards) — omitted because they only apply to panelized
projects, not a single board.
"""
...
# Empty schematic sheet document (docType 1), copied literally from a real document
# ("p1" of eblocks.eprj2, no symbols — just the standard title block). The current Pro emitter
# does not generate a real schematic (only PCB), so every emitted project uses this empty sheet
# as a stub — enough for the project to open correctly in Pro, but with no schematic value.
EMPTY_SCHEMATIC_LINES: list[str] = [
    '["DOCTYPE","SCH","1.1"]',
    '["HEAD",{"originX":0,"originY":0,"version":"2","maxId":30}]',
    '["COMPONENT","e1","",0,0,0,0,{},0]',
    '["FONTSTYLE","st1",null,null,null,20,null,null,null,null,1,1]',
    '["ATTR","e3","e1","@Project Name","Project Name",0,0,919,300,0,"st1",0]',
    '["FONTSTYLE","st2",null,null,null,15,null,null,null,null,1,1]',
    '["ATTR","e4","e1","@Page Count","1",0,0,1101,261,0,"st2",0]',
    '["FONTSTYLE","st3",null,null,null,15,null,null,null,null,1,0]',
    '["ATTR","e5","e1","@Update Date","",0,0,1009,380,0,"st3",0]',
    '["ATTR","e6","e1","@Create Date","",0,0,1009,360,0,"st3",0]',
    '["ATTR","e7","e1","@Schematic Name","Schematic Name",0,0,729,370,0,"st1",0]',
    '["ATTR","e8","e1","@Page No","1",0,0,984,261,0,"st2",0]',
    '["ATTR","e9","e1","@Page Name","P1",0,0,729,340,0,"st2",0]',
    '["ATTR","e10","e1","Company","","",0,0,997,230,0,"st1",0]',
    '["ATTR","e11","e1","Reviewed","",0,0,557,300,0,"st3",0]',
    '["ATTR","e12","e1","Version","V1.0",0,0,717,230,0,"st2",0]',
    '["ATTR","e13","e1","Page Size","A4",0,0,799,230,0,"st2",0]',
    '["ATTR","e14","e1","Drawn","",0,0,557,320,0,"st3",0]',
    '["FONTSTYLE","st4",null,null,null,null,null,null,null,null,null,null]',
    '["ATTR","e15","e1","Name","",0,0,null,null,0,"st4",0]',
    '["ATTR","e18","e1","Border","1",0,0,null,null,0,"st4",0]',
    '["ATTR","e19","e1","Width","1170",0,0,null,null,0,"st4",0]',
    '["ATTR","e20","e1","Height","825",0,0,null,null,0,"st4",0]',
    '["ATTR","e26","e1","Title Block Position","3",0,0,null,null,0,"st4",0]',
    '["ATTR","e27","e1","Title Block","1",0,0,null,null,0,"st4",0]',
]
